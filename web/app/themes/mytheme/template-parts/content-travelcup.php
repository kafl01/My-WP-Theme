        ...
        <div id="myCarousel" class="carousel slide" data-bs-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="<?php echo get_theme_file_uri('/images/fotboll_court1.jpg') ?>" class="d-block h-50 w-100" alt="...">
                </div>
                <div class="carousel-item">
                    <img src="<?php echo get_theme_file_uri('/images/fotball_play.jpg') ?>" class="d-block w-100" alt="...">
                </div>
                <div class="carousel-item">
...
<div class="container marketing mx-5">
    ...
    <div class="row my-5">
        ...
        <div class="col-lg-4 py-4">
            <svg class="rounded-circle bg-primary p-3 mb-4" width="100" height="100"></svg>
            <h3>Datum för hemresa</h3>
            <p class="pe-4"><?php echo get_post_meta($post->ID, 'travel_to_date', true); ?></p>
        </div><!-- /.col-lg-4 -->
        <div class="col-lg-4 py-4">
            <svg class="rounded-circle bg-primary p-3 mb-4" width="100" height="100"></svg>
            <h3>Ort</h3>
            <p class="pe-4"><?php echo get_post_meta($post->ID, 'travel_place', true); ?></p>
        </div><!-- /.col-lg-4 -->
    </div><!-- /.row -->
    <hr class="featurette-divider bg-primary">
    ...
    <div class="row my-5">
        ...
        <div class="col-lg-4 py-4">
            ...
            <ul>
                <?php
                $travelages = get_terms('travel_age');
                if ($travelages) :
                    foreach ($travelages as $age) : ?>
                        <li>
                            <a href="<?php echo get_tag_link($age->term_id); ?>">
                                <?php echo $age->name; ?>
                            </a>
                        </li>
                <?php endforeach;
        ...
        <div class="col-lg-4 py-4">
            ...
            <ul>
                <?php
                $travelcountries = get_terms('travel_country');
                if ($travelcountries) :
                    foreach ($travelcountries as $country) : ?>
                        <li>
                            <a href="<?php echo get_tag_link($country->term_id); ?>">
        ...
        <div class="col-lg-4 py-4">
            ...
            <ul>
                <?php
                $travelsports = get_terms('travel_sport_type');
                if ($travelsports) :
                    foreach ($travelsports as $sport) : ?>
                        <li>
                            <a href="<?php echo get_tag_link($sport->term_id); ?>">
                                <?php echo $sport->name; ?>
                            </a>
                        </li>
                <?php endforeach;
